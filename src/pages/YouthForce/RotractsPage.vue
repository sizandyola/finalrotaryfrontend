    ...
    <div class="row my-2">
      <div class="col-md-6">
        <p style="text-align:justify">
          The Rotaract Club of Kathmandu Mid-Town, was chartered on 16 February 1998. Over the past 19 years our Rotractors have been involved in numerous noteworthy projects and have received many RID 3292 and Rotary International accolades for their work. But, most of all, our Rotractors need to be recognized for the outstanding, selfless work that they did and continue to do for the earthquake relief effort both in the immediate aftermath of the disaster and to this day.
        ...
        <br> <br>
         <a href="/images/rotaracts/youthrotaracts.pdf" target="_blank" style="font-size:18px">Read More (February)</a> <br>
         <a href="/images/rotaracts/youthrotaracts2.pdf" target="_blank" style="font-size:18px">Read More (March-April)</a>
        </p>
        ...
        <b >
          ...
          <a href="https://rotaractnepal.org.np" class="web-links" target="_blank">
            <i class="fas fa-globe"></i> https://rotaractnepal.org.np
          </a>
        </b>
        <br />
        <br />
      ...
      <div class="col-md-6 text-center">
        ...
        <!-- <img src="/images/rotracts.jpg" class="img-fluid" />
         <img src="/images/rotaract.jpg" class="img-fluid mt-2" style="max-height:500px"/> -->
      </div>
